...
class _ChecklistLaboresPermanentesScreenState extends State<ChecklistLaboresPermanentesScreen> {
  ...
  // paradas: parada (1-5) -> {resultados por item (1-12)}
  ...
  final TextEditingController _upController = TextEditingController();
  ...
  // Lista de labores permanentes (12 items exactos del Excel)
  ...
  void _loadExistingChecklist() {
    ...
    _upController.text = checklist.up ?? '';
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'UP',
                      hintText: 'Unidad Productiva',
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                      prefixIcon: Icon(Icons.business, color: Colors.deepPurple[700]),
                    ),
                  ),
                ),
                SizedBox(width: 20),
  ...
  Future<void> _saveChecklist() async {
    ...
    try {
      ...
      checklist = ChecklistLaboresPermanentes(
        ...
        fecha: selectedDate,
        finca: selectedFinca,
        up: _upController.text.trim().isEmpty ? null : _upController.text.trim(),
        semana: _semanaController.text.trim().isEmpty ? null : _semanaController.text.trim(),
        kontroller: selectedUsuario?.nombre,
                  ...
                  content: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text('1. Complete información general (UP, Semana, Kontroller)'),
                        Text('2. Seleccione fecha y finca'),
                        Text('3. Agregue filas: supervisor, bloque, variedad, cuadrante'),
                        Text('4. Evalúe cada parada (1-5) para cada ítem (1-12)'),
                        ...
                        Text('• 12 ítems de control por parada'),
                        Text('• Valores: 1=Conforme, 0=No Conforme'),
                        SizedBox(height: 12),
                        Text('12 Ítems de Control:', style: TextStyle(fontWeight: FontWeight.bold)),
                        Container(
                          height: 200,
