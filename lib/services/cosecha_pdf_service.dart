...
class CosechaPDFService {
  ...
  static pw.Widget _construirResumenCumplimiento(Map<String, dynamic> data) {
    ...
    print('[PDF][COSECHA] Usando porcentaje de la base de datos: $porcentaje%');
    ...
    print('[PDF][COSECHA] Total items: $totalItems, Conformes: $conformes, No conformes: $noConformes, Porcentaje: $porcentajeRedondeado%');
