...
class BodegaPDFService {
  ...
  static pw.Widget _construirResumenCumplimiento(Map<String, dynamic> data) {
    ...
    print('[PDF][BODEGA] Usando porcentaje de la base de datos: $porcentaje%');
    ...
    print('[PDF][BODEGA] Total items: $totalItems, Conformes: $conformes, No conformes: $noConformes, Porcentaje: $porcentajeRedondeado%');
